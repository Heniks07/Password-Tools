        ...
        private int input()
        {
            ...
            if (Input == "?")
            {
                ...
                Console.WriteLine(
                    ...
                    " clf\tswitch file clearing before pswd generateCombination on/off (curerently " + doClearFOn + " )\n" +
                    " c\tclear console now\n" +
                    " cf\tclear file now\n" +
                    " rm\tremove file now\n" +
                    "\nOther\n\n" +
            ...
            if (Input == "cl")
            {
                ...
                Console.WriteLine(doClearC == true ? "console clearing on input now on" : "console clearing before pswd generateCombination now off");
                return 0;
            }
            if (Input == "clf")
            {
                doClearF = doClearF == true ? false : true;
                Console.WriteLine(doClearF == true ? "file clearing before pswd generateCombination now on" : "file clearing before pswd generateCombination now off");
                return 0;
            }
            if (Input == "c")
            {
